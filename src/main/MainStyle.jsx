...
export const StyledDiv01 = styled.div`
  font-size: 5rem;
...
export const InfoContainer = styled.div`
  ...
  height: auto;
  background-color: rgba(255, 255, 255, 0.08);
  box-shadow: inset 0px 20px 50px rgba(255, 255, 255, 0.05);
  backdrop-filter: blur(20px);
  border-radius: 5rem;
  margin-top: 1rem;
  ...
  .infobox {
    ...
    box-shadow: inset 0px 10px 45px rgba(0, 0, 0, 0.2);
    color: white;
    padding: 2.5rem;
    #infoline {
      animation: ${(props) =>
